...
public class APIController {
    ...
    @GetMapping("ctftime")
    public ResponseEntity<List<Map<String,String>>> ctfTime() throws IOException {
        return ResponseEntity.ok().body(apiService.ctfTimeGetApi());
    }

    @GetMapping("geeknews")
    public ResponseEntity<Page<News>> geekNewspage(@RequestParam(value="page", defaultValue="0") int page,
